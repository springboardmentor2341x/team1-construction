        ...
        <div class="col-lg-10 col-md-9 p-4 bg-light-subtle min-vh-100 animate-fade-in">
          <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
            <div>
              ...
              <p class="text-muted small mb-0">Generate weekly summaries from daily progress reports for each project.</p>
            </div>
          ...
          <div class="card card-custom border-0 p-4 mb-4" *ngIf="showForm()">
            ...
            <p class="text-muted small mt-3 mb-0">
              ...
              Completed work, major activities, and delays are auto-aggregated from daily progress reports in the selected week.
            </p>
          </div>
                ...
                <div class="border rounded-3 p-3 bg-white">
                  ...
                  <div class="row g-2 small">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="bg-light rounded-3 p-2">{{ w.majorActivities || 'N/A' }}</div>
                      <div class="text-muted mt-2 mb-1"><i class="bi bi-exclamation-triangle me-1 text-danger"></i><strong>Delays:</strong></div>
                      <div class="bg-light rounded-3 p-2">{{ w.delays || 'None' }}</div>
                    </div>
                  </div>
                  <div class="d-flex justify-content-between extra-small text-muted border-top pt-2 mt-2">
                    <span><i class="bi bi-person me-1"></i>Generated by: <strong>{{ w.generatedBy }}</strong></span>
                    <span *ngIf="w.safetyIncidents"><i class="bi bi-shield me-1"></i>{{ w.safetyIncidents }}</span>
                  </div>
                </div>
              </div>
